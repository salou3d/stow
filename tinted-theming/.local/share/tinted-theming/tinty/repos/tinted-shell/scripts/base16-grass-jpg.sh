...
color01="c9/55/27" # Base 08 - Red
color02="3f/ae/75" # Base 0B - Green
color03="f7/b7/4c" # Base 0A - Yellow
color04="08/3e/d4" # Base 0D - Blue
color05="89/51/94" # Base 0E - Magenta
...
color16="f6/7c/25" # Base 09
color17="a9/5c/6a" # Base 0F
...
if [ -n "$TINTED_SHELL_ENABLE_BASE16_VARS" ] || [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  ...
  export BASE16_COLOR_08_HEX="c95527"
  export BASE16_COLOR_09_HEX="f67c25"
  export BASE16_COLOR_0A_HEX="f7b74c"
  export BASE16_COLOR_0B_HEX="3fae75"
  export BASE16_COLOR_0C_HEX="36aad7"
  export BASE16_COLOR_0D_HEX="083ed4"
  export BASE16_COLOR_0E_HEX="895194"
  export BASE16_COLOR_0F_HEX="a95c6a"
fi
