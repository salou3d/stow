...
color01="98/6a/5c" # Base 08 - Red
color02="5d/e3/4c" # Base 0B - Green
color03="ad/dc/57" # Base 0A - Yellow
color04="1e/36/da" # Base 0D - Blue
color05="84/2c/8e" # Base 0E - Magenta
color06="22/c3/c3" # Base 0C - Cyan
...
color16="9d/ac/4b" # Base 09
color17="94/73/5f" # Base 0F
...
if [ -n "$TINTED_SHELL_ENABLE_BASE16_VARS" ] || [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  ...
  export BASE16_COLOR_08_HEX="986a5c"
  export BASE16_COLOR_09_HEX="9dac4b"
  export BASE16_COLOR_0A_HEX="addc57"
  export BASE16_COLOR_0B_HEX="5de34c"
  export BASE16_COLOR_0C_HEX="22c3c3"
  export BASE16_COLOR_0D_HEX="1e36da"
  export BASE16_COLOR_0E_HEX="842c8e"
  export BASE16_COLOR_0F_HEX="94735f"
fi
